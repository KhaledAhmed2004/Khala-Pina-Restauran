...
//   return (
//     <header className="max-w-7xl mx-auto bg-white text-[#2f2f2f] w-full duration-200 ease-in sticky top-2 left-0 right-0 rounded-tl-[45px] rounded-bl-[25px] rounded-tr-[40px] rounded-br-[25px] border-[2px] border-[#dddddd]">
//       <nav className="h-[4.3rem] flex justify-between items-center px-6">
...
//         <div
//           style={{ boxShadow: "-5px -5px 9px #ffffff73,5px 5px 7px #5e687949" }}
//           className={
//             menuIcon
//               ? "md:hidden absolute top-[4.8rem] right-0 bottom-0 left-0 flex justify-center w-full h-[80vh] bg-[#FFFFFF1A] text-white ease-in duration-300 text-center items-center rounded-tl-[50px] rounded-bl-[65px] rounded-tr-[65px] rounded-br-[50px] border-2 shadow-2xl backdrop-blur-3xl"
...
const Navbar = () => {
  ...
  return (
    <header className="px-[0.375rem] xl:px-0 w-full duration-200 ease-in sticky top-2 left-0 right-0">
      <nav className="h-[4.3rem] flex justify-between items-center px-6 rounded-tl-[45px] rounded-bl-[25px] rounded-tr-[40px] rounded-br-[25px] border-[2px] border-[#dddddd] bg-white text-[#2f2f2f]">
        <div className="lg:flex-1 h-full justify-center">
          <Link to="/">
            <img className="h-full" src={logo} alt="" />
          </Link>
